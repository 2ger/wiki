...
- **thinkphp5.0**
    ...
    - [getAvailableDrivers](?file=003-后端代码/005-thinkphp5.0/008-getAvailableDrivers "getAvailableDrivers")
    ...
    - [exec执行一个SQL语句影响行数](?file=003-后端代码/005-thinkphp5.0/011-exec执行一个SQL语句影响行数 "exec执行一个SQL语句影响行数")
    - [query执行SQL语句返回](?file=003-后端代码/005-thinkphp5.0/012-query执行SQL语句返回 "query执行SQL语句返回")
    ...
    - [inTransaction检查](?file=003-后端代码/005-thinkphp5.0/016-inTransaction检查 "inTransaction检查")
    - [lastInsertId插入行的ID或序列值](?file=003-后端代码/005-thinkphp5.0/017-lastInsertId插入行的ID或序列值 "lastInsertId插入行的ID或序列值")
    - [errorCode获取操作错误码](?file=003-后端代码/005-thinkphp5.0/018-errorCode获取操作错误码 "errorCode获取操作错误码")
    - [errorInfo获取操作错误信息](?file=003-后端代码/005-thinkphp5.0/019-errorInfo获取操作错误信息 "errorInfo获取操作错误信息")
    ...
    - [execute执行PDOprepare](?file=003-后端代码/005-thinkphp5.0/023-execute执行PDOprepare "execute执行PDOprepare")
