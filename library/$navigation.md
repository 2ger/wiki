...
- **thinkphp5.0**
    ...
    - [PDO预处理语句与存储过程](?file=003-后端代码/005-thinkphp5.0/002-PDO预处理语句与存储过程 "PDO预处理语句与存储过程")
    - [PDO事务和自动提交](?file=003-后端代码/005-thinkphp5.0/003-PDO事务和自动提交 "PDO事务和自动提交")
    - [PDO错误和错误处理](?file=003-后端代码/005-thinkphp5.0/004-PDO错误和错误处理 "PDO错误和错误处理")
    - [ __construct()构造函数](?file=003-后端代码/005-thinkphp5.0/005- __construct()构造函数 " __construct()构造函数")
    - [setAttribute() PDO属性设置](?file=003-后端代码/005-thinkphp5.0/006-setAttribute() PDO属性设置 "setAttribute() PDO属性设置")
    - [getAttribute() PDO属性获取](?file=003-后端代码/005-thinkphp5.0/007-getAttribute() PDO属性获取 "getAttribute() PDO属性获取")
    - [getAvailableDrivers() 返回可用驱动的数组](?file=003-后端代码/005-thinkphp5.0/008-getAvailableDrivers() 返回可用驱动的数组 "getAvailableDrivers() 返回可用驱动的数组")
    - [quote() 语句转义处理](?file=003-后端代码/005-thinkphp5.0/009-quote() 语句转义处理 "quote() 语句转义处理")
    - [prepare() 准备待执行SQL语句](?file=003-后端代码/005-thinkphp5.0/010-prepare() 准备待执行SQL语句 "prepare() 准备待执行SQL语句")
    - [exec() 执行一个SQL语句，返回受此语句影响的行数](?file=003-后端代码/005-thinkphp5.0/011-exec() 执行一个SQL语句，返回受此语句影响的行数 "exec() 执行一个SQL语句，返回受此语句影响的行数")
    - [query() 执行SQL语句，返回PDOStatement对象](?file=003-后端代码/005-thinkphp5.0/012-query() 执行SQL语句，返回PDOStatement对象 "query() 执行SQL语句，返回PDOStatement对象")
    - [beginTransaction 启动事务](?file=003-后端代码/005-thinkphp5.0/013-beginTransaction 启动事务 "beginTransaction 启动事务")
    - [commint() 手动提交事务](?file=003-后端代码/005-thinkphp5.0/014-commint() 手动提交事务 "commint() 手动提交事务")
    - [rollBack() 回滚一个事务](?file=003-后端代码/005-thinkphp5.0/015-rollBack() 回滚一个事务 "rollBack() 回滚一个事务")
    - [inTransaction() 检查是否在一个事务内](?file=003-后端代码/005-thinkphp5.0/016-inTransaction() 检查是否在一个事务内 "inTransaction() 检查是否在一个事务内")
    - [lastInsertId() 返回最后插入行的ID或序列值](?file=003-后端代码/005-thinkphp5.0/017-lastInsertId() 返回最后插入行的ID或序列值 "lastInsertId() 返回最后插入行的ID或序列值")
    - [errorCode() 获取上次数据库操作错误码](?file=003-后端代码/005-thinkphp5.0/018-errorCode() 获取上次数据库操作错误码 "errorCode() 获取上次数据库操作错误码")
    - [errorInfo() 获取上次数据库操作错误信息](?file=003-后端代码/005-thinkphp5.0/019-errorInfo() 获取上次数据库操作错误信息 "errorInfo() 获取上次数据库操作错误信息")
    - [bindParam() 绑定参数到预处理语句](?file=003-后端代码/005-thinkphp5.0/020-bindParam() 绑定参数到预处理语句 "bindParam() 绑定参数到预处理语句")
    - [bindValue() 绑定一个值到一个参数](?file=003-后端代码/005-thinkphp5.0/021-bindValue() 绑定一个值到一个参数 "bindValue() 绑定一个值到一个参数")
    - [bindColumn() 绑定一列到一个PHP变量](?file=003-后端代码/005-thinkphp5.0/022-bindColumn() 绑定一列到一个PHP变量 "bindColumn() 绑定一列到一个PHP变量")
    - [execute() 执行PDOprepare()生成的预处理语句](?file=003-后端代码/005-thinkphp5.0/023-execute() 执行PDOprepare()生成的预处理语句 "execute() 执行PDOprepare()生成的预处理语句")
    - [fetch() 从结果集中获取下一行](?file=003-后端代码/005-thinkphp5.0/024-fetch() 从结果集中获取下一行 "fetch() 从结果集中获取下一行")
    - [fetchAll() 返回结果集中所有行的数组](?file=003-后端代码/005-thinkphp5.0/025-fetchAll() 返回结果集中所有行的数组 "fetchAll() 返回结果集中所有行的数组")
    - [fetchColumn() 返回结果集中的下一行单独的一列](?file=003-后端代码/005-thinkphp5.0/026-fetchColumn() 返回结果集中的下一行单独的一列 "fetchColumn() 返回结果集中的下一行单独的一列")
    - [fetchObject() 将下一行作为一个对象返回](?file=003-后端代码/005-thinkphp5.0/027-fetchObject() 将下一行作为一个对象返回 "fetchObject() 将下一行作为一个对象返回")
