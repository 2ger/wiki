...
- **thinkphp5.0**
    ...
    - [construct构造函数](?file=003-后端代码/005-thinkphp5.0/005-construct构造函数 "construct构造函数")
    - [setAttributePDO属性设置](?file=003-后端代码/005-thinkphp5.0/006-setAttributePDO属性设置 "setAttributePDO属性设置")
    - [getAttributePDO属性获取](?file=003-后端代码/005-thinkphp5.0/007-getAttributePDO属性获取 "getAttributePDO属性获取")
    - [getAvailableDrivers返回可用驱动的数组](?file=003-后端代码/005-thinkphp5.0/008-getAvailableDrivers返回可用驱动的数组 "getAvailableDrivers返回可用驱动的数组")
    - [quote语句转义处理](?file=003-后端代码/005-thinkphp5.0/009-quote语句转义处理 "quote语句转义处理")
    - [prepare准备待执行SQL语句](?file=003-后端代码/005-thinkphp5.0/010-prepare准备待执行SQL语句 "prepare准备待执行SQL语句")
    - [exec执行一个SQL语句返回受此语句影响的行数](?file=003-后端代码/005-thinkphp5.0/011-exec执行一个SQL语句返回受此语句影响的行数 "exec执行一个SQL语句返回受此语句影响的行数")
    - [query执行SQL语句返回PDOStatement对象](?file=003-后端代码/005-thinkphp5.0/012-query执行SQL语句返回PDOStatement对象 "query执行SQL语句返回PDOStatement对象")
    - [beginTransaction启动事务](?file=003-后端代码/005-thinkphp5.0/013-beginTransaction启动事务 "beginTransaction启动事务")
    - [commint手动提交事务](?file=003-后端代码/005-thinkphp5.0/014-commint手动提交事务 "commint手动提交事务")
    - [rollBack回滚一个事务](?file=003-后端代码/005-thinkphp5.0/015-rollBack回滚一个事务 "rollBack回滚一个事务")
    - [inTransaction检查是否在一个事务内](?file=003-后端代码/005-thinkphp5.0/016-inTransaction检查是否在一个事务内 "inTransaction检查是否在一个事务内")
    - [lastInsertId返回最后插入行的ID或序列值](?file=003-后端代码/005-thinkphp5.0/017-lastInsertId返回最后插入行的ID或序列值 "lastInsertId返回最后插入行的ID或序列值")
    - [errorCode获取上次数据库操作错误码](?file=003-后端代码/005-thinkphp5.0/018-errorCode获取上次数据库操作错误码 "errorCode获取上次数据库操作错误码")
    - [errorInfo获取上次数据库操作错误信息](?file=003-后端代码/005-thinkphp5.0/019-errorInfo获取上次数据库操作错误信息 "errorInfo获取上次数据库操作错误信息")
    - [bindParam绑定参数到预处理语句](?file=003-后端代码/005-thinkphp5.0/020-bindParam绑定参数到预处理语句 "bindParam绑定参数到预处理语句")
    - [bindValue绑定一个值到一个参数](?file=003-后端代码/005-thinkphp5.0/021-bindValue绑定一个值到一个参数 "bindValue绑定一个值到一个参数")
    - [bindColumn绑定一列到一个PHP变量](?file=003-后端代码/005-thinkphp5.0/022-bindColumn绑定一列到一个PHP变量 "bindColumn绑定一列到一个PHP变量")
    - [execute执行PDOprepare生成的预处理语句](?file=003-后端代码/005-thinkphp5.0/023-execute执行PDOprepare生成的预处理语句 "execute执行PDOprepare生成的预处理语句")
    - [fetch从结果集中获取下一行](?file=003-后端代码/005-thinkphp5.0/024-fetch从结果集中获取下一行 "fetch从结果集中获取下一行")
    - [fetchAll返回结果集中所有行的数组](?file=003-后端代码/005-thinkphp5.0/025-fetchAll返回结果集中所有行的数组 "fetchAll返回结果集中所有行的数组")
    - [fetchColumn返回结果集中的下一行单独的一列](?file=003-后端代码/005-thinkphp5.0/026-fetchColumn返回结果集中的下一行单独的一列 "fetchColumn返回结果集中的下一行单独的一列")
    - [fetchObject将下一行作为一个对象返回](?file=003-后端代码/005-thinkphp5.0/027-fetchObject将下一行作为一个对象返回 "fetchObject将下一行作为一个对象返回")
